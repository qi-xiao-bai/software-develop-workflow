...
Install or reference this folder as the Codex skill package, then start from [SKILL.md](./SKILL.md) or [SKILL_CN.md](./SKILL_CN.md).
...
把这个目录当成 Codex 的 skill 包来安装或引用，然后从 [SKILL.md](./SKILL.md) 或 [SKILL_CN.md](./SKILL_CN.md) 开始。
